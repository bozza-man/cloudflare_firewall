...
- **Critical Function:** Ensures essential DNS services always work (Warp.dev, Anthropic, Apple, Cloudflare, SimpleMDM, Ubiquiti, Microsoft)
...
- **Critical Function:** Ensures essential HTTP/HTTPS services always work (same domains as DNS rule)
...
- [ ] Critical infrastructure rules include all essential domains (Warp.dev, Anthropic, Apple, Cloudflare, SimpleMDM, Ubiquiti, Microsoft)
